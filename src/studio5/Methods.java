...
public class Methods {
	...
	public static String substituteAll(String source, char target, String replacement) {
		String result = source.replace(Character.toString(target), replacement);
		return result;
	}
	...
	/**
	 * Compute the mean (average) of the elements in an array
	 * 
	 * @param values an array of integers
	 * @return the mean of the elements in values
	 */
	public static double arrayMean(int[] values) {
		int sum = arraySum(values); // Reusing the arraySum method
